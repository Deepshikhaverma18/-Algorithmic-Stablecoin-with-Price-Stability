...
This project implement an algorithmic stablecoin on Ethereum-compatible networks that maintains price stability via supply adjustments. It integrates a price oracles and automatically mints or burns tokens to keep the stablecoin pegged to a target prices (e.g., $1).
